...
function getSign(e, t, n) {
    var a = require("underscore.js"), r = require("md5.js"), i = "", s = getUrlParam(e, "sign");
    ...
    f < i.length - 1 && (c += "&"));
    return s = r(c + (n = n || getApp().siteInfo.token));
}
...
util.url = function(e, t) {
    ...
    this.isLeapYear = function(e) {
        ...
        var s = 0;
        -1 < (a = e.indexOf("dd")) && a < r && (s = parseInt(t.substr(a, 2)));
        var o = 0;
        (-1 < (a = e.indexOf("HH")) || 1 < (a = e.indexOf("hh"))) && a < r && (o = parseInt(t.substr(a, 2)));
        var u = 0;
        -1 < (a = e.indexOf("mm")) && a < r && (u = t.substr(a, 2));
        var c = 0;
        return -1 < (a = e.indexOf("ss")) && a < r && (c = t.substr(a, 2)), new Date(n, i, s, o, u, c);
        ...
        return !(!isNumber(a) || "2100" < a || a < "1900") && (!(!isNumber(i) || "12" < i || i < "01") && !(o > getMaxDay(a, i) || o < "01"));
